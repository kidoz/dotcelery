...
/// <summary>
/// Configuration options for <see cref="PostgresInboxStore"/>.
/// </summary>
public sealed class PostgresInboxStoreOptions
{
    private string _connectionString = "Host=localhost;Database=celery";
    private string _schema = "public";
    private string _tableName = "celery_inbox";
    ...
    /// <summary>
    /// Gets or sets the table name for inbox records.
    /// </summary>
